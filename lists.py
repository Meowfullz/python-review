# the list is one of pythons main ordered collections
...
# In this case of this list, -5, -4, -3, -2, -1 are the
# only valid indices, with -1 being the index for the last element
...
#These lines of code add multiple elements tp the list using a loop
for i in range(1,5):
	names.append(i)
...
#an error will be generated if the value doesnt exist in the list
# names.remove([1,2,3])

#Only the first occurance of the value will be removed from the lsit.
names.remove('Lea')
